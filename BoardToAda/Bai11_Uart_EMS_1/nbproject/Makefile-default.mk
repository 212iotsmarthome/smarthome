...
${OBJECTDIR}/mystring.o: mystring.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mystring.o.d 
	@${RM} ${OBJECTDIR}/mystring.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/mystring.o   mystring.c 
	@${DEP_GEN} -d ${OBJECTDIR}/mystring.o 
	@${FIXDEPS} "${OBJECTDIR}/mystring.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/uartProcess.o: uartProcess.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/uartProcess.o.d 
	@${RM} ${OBJECTDIR}/uartProcess.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/uartProcess.o   uartProcess.c 
	@${DEP_GEN} -d ${OBJECTDIR}/uartProcess.o 
	@${FIXDEPS} "${OBJECTDIR}/uartProcess.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/DHT11.o: DHT11.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/DHT11.o.d 
	@${RM} ${OBJECTDIR}/DHT11.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/DHT11.o   DHT11.c 
...
${OBJECTDIR}/delay.o: delay.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/delay.o   delay.c 
...
${OBJECTDIR}/two_mode_led.o: two_mode_led.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/two_mode_led.o.d 
	@${RM} ${OBJECTDIR}/two_mode_led.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/two_mode_led.o   two_mode_led.c 
	@${DEP_GEN} -d ${OBJECTDIR}/two_mode_led.o 
	@${FIXDEPS} "${OBJECTDIR}/two_mode_led.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/spi_74hc595.o: spi_74hc595.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/spi_74hc595.o.d 
	@${RM} ${OBJECTDIR}/spi_74hc595.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/spi_74hc595.o   spi_74hc595.c 
	@${DEP_GEN} -d ${OBJECTDIR}/spi_74hc595.o 
	@${FIXDEPS} "${OBJECTDIR}/spi_74hc595.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/door.o: door.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/door.o.d 
	@${RM} ${OBJECTDIR}/door.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/door.o   door.c 
	@${DEP_GEN} -d ${OBJECTDIR}/door.o 
	@${FIXDEPS} "${OBJECTDIR}/door.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/curtain.o: curtain.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/curtain.o.d 
	@${RM} ${OBJECTDIR}/curtain.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/curtain.o   curtain.c 
	@${DEP_GEN} -d ${OBJECTDIR}/curtain.o 
	@${FIXDEPS} "${OBJECTDIR}/curtain.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/conditioner.o: conditioner.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/conditioner.o.d 
	@${RM} ${OBJECTDIR}/conditioner.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/conditioner.o   conditioner.c 
	@${DEP_GEN} -d ${OBJECTDIR}/conditioner.o 
	@${FIXDEPS} "${OBJECTDIR}/conditioner.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/gas_sensor.o: gas_sensor.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/gas_sensor.o.d 
	@${RM} ${OBJECTDIR}/gas_sensor.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/gas_sensor.o   gas_sensor.c 
...
${OBJECTDIR}/mystring.o: mystring.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/mystring.o.d 
	@${RM} ${OBJECTDIR}/mystring.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/mystring.o   mystring.c 
	@${DEP_GEN} -d ${OBJECTDIR}/mystring.o 
	@${FIXDEPS} "${OBJECTDIR}/mystring.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/uartProcess.o: uartProcess.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/uartProcess.o.d 
	@${RM} ${OBJECTDIR}/uartProcess.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/uartProcess.o   uartProcess.c 
	@${DEP_GEN} -d ${OBJECTDIR}/uartProcess.o 
	@${FIXDEPS} "${OBJECTDIR}/uartProcess.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/two_mode_led.o: two_mode_led.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/two_mode_led.o.d 
	@${RM} ${OBJECTDIR}/two_mode_led.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/two_mode_led.o   two_mode_led.c 
	@${DEP_GEN} -d ${OBJECTDIR}/two_mode_led.o 
	@${FIXDEPS} "${OBJECTDIR}/two_mode_led.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/spi_74hc595.o: spi_74hc595.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/spi_74hc595.o.d 
	@${RM} ${OBJECTDIR}/spi_74hc595.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/spi_74hc595.o   spi_74hc595.c 
	@${DEP_GEN} -d ${OBJECTDIR}/spi_74hc595.o 
	@${FIXDEPS} "${OBJECTDIR}/spi_74hc595.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/door.o: door.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/door.o.d 
	@${RM} ${OBJECTDIR}/door.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/door.o   door.c 
	@${DEP_GEN} -d ${OBJECTDIR}/door.o 
	@${FIXDEPS} "${OBJECTDIR}/door.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/curtain.o: curtain.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/curtain.o.d 
	@${RM} ${OBJECTDIR}/curtain.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/curtain.o   curtain.c 
	@${DEP_GEN} -d ${OBJECTDIR}/curtain.o 
	@${FIXDEPS} "${OBJECTDIR}/curtain.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/conditioner.o: conditioner.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/conditioner.o.d 
	@${RM} ${OBJECTDIR}/conditioner.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/conditioner.o   conditioner.c 
	@${DEP_GEN} -d ${OBJECTDIR}/conditioner.o 
	@${FIXDEPS} "${OBJECTDIR}/conditioner.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
